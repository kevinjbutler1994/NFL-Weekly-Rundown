...
function setModal(teamData) {
  ...
  descText.innerText = ('Wins')
  descText2.innerText = (teamData.wins)
  descText3.innerText = ('Losses')
  descText4.innerText = (teamData.loss)
  descText5.innerText = ('Rushing Yards')
   descText6.innerText = (teamData.teamStats.Rushing.rushYds)
  descText7.innerText = ('Passing Yards')
  descText8.innerText = (teamData.teamStats.Passing.passYds)
  descText9.innerText = ('Current Win Streak')  
  descText10.innerText = (teamData.currentStreak.length)
  descText11.innerText = ('Offensive Star of the Week')
  descText12.innerText = (teamData.topPerformers.Receiving.recYds.playerID)
  descText13.innerText = ('Defensive Star of the Week')
  descText14.innerText = (teamData.topPerformers.Defense.totalTackles.playerID)
